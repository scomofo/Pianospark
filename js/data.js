...
var SCR = { HOME: 0, SESSION: 1, ONBOARDING: 2 };
var TAB = {
...
var SESSION_PLANS = [
  ...
  { num:1, title:"Hello, Piano", level:1,
    ...
    newMove:{ text:"Find middle C. Thumb (1) on C, middle finger (3) on E, pinky (5) on G. Press all three together. That's C major! Repeat 10x.",
              ...
              watchDuration:30, shadowDuration:30, tryDuration:120, refineDuration:60 },
    songSlice:{ text:"Play C major as a drone under Row Row Row Your Boat.",
                song:"Row Row Row Your Boat", duration:240, observePriming:15 },
  ...
  { num:2, title:"The Chord Machine", level:1,
    ...
    review:{ chords:["C"], text:"Play C major 4x clean, lift between each.", duration:120 },
    ...
    songSlice:{ text:"Play C in rhythm \u2014 4 beats on, 4 beats rest. Metronome at 60 BPM.",
                song:"Twinkle Twinkle", duration:240, observePriming:15 },
  ...
  { num:3, title:"Both Hands Wake Up", level:1,
    ...
    review:{ chords:["C"], text:"C major in rhythm at 60 BPM.", duration:120 },
  ...
  { num:4, title:"The F Chord (Your Hand Barely Moves)", level:2,
    ...
    review:{ chords:["C"], text:"LH C + RH C major, 4 reps at 60 BPM.", duration:120 },
    ...
    songSlice:{ text:"Alternate C and F every 4 beats with metronome.",
                song:"La Bamba", duration:240, observePriming:15 },
  ...
  { num:5, title:"The G Chord (Smooth Slide)", level:2,
    ...
    review:{ chords:["C","F"], text:"C \u2192 F transitions, back and forth.", duration:120 },
  ...
  { num:6, title:"I-IV-V Power", level:2,
    ...
    review:{ chords:["C","F","G"], text:"C \u2192 F \u2192 G \u2192 C cycle.", duration:120 },
    ...
    songSlice:{ text:"'Happy Birthday' \u2014 C, F, G. Play along slowly.",
                song:"Happy Birthday", duration:240, observePriming:15 },
  ...
  { num:7, title:"12-Bar Blues on Piano", level:2,
    ...
    review:{ chords:["C","F","G"], text:"C-F-G cycle, smooth.", duration:120 },
    ...
    songSlice:{ text:"Play 12-bar blues with backing track. Slow tempo.",
                song:"12-Bar Blues", duration:240, observePriming:15 },
  ...
  { num:8, title:"LH Upgrade \u2014 Half Notes", level:2,
    ...
    review:{ chords:["C","F","G"], text:"12-bar blues pattern.", duration:120 },
  ...
  { num:9, title:"The Am Chord (One Finger Moves!)", level:3,
    ...
    review:{ chords:["C","F","G"], text:"C \u2192 F \u2192 G cycle with half-note bass.", duration:120 },
    ...
    songSlice:{ text:"C \u2192 Am \u2192 C \u2192 Am. Hear the emotional shift. Major to minor.",
                song:"Let It Be", duration:240, observePriming:15 },
  ...
  { num:10, title:"The Em Chord", level:3,
    ...
    review:{ chords:["C","Am"], text:"C \u2192 Am transitions.", duration:120 },
    ...
    songSlice:{ text:"Em \u2192 Am \u2192 C chain. Three chords, all connected by voice leading.",
                song:"Stand By Me", duration:240, observePriming:15 },
  ...
  { num:11, title:"The Pop Loop", level:3,
    ...
    review:{ chords:["Em","Am","C"], text:"Em \u2192 Am \u2192 C chain.", duration:120 },
  ...
  { num:12, title:"Let It Be", level:3,
    ...
    review:{ chords:["C","G","Am","F"], text:"Pop loop.", duration:120 },
  ...
  { num:13, title:"Stand By Me", level:3,
    ...
    review:{ chords:["C","G","Am","F"], text:"'Let It Be' progression.", duration:120 },
  ...
  { num:14, title:"Level 3 Boss \u2014 Root-Fifth Bass", level:3,
    ...
    review:{ chords:["C","Am","F","G"], text:"Learner's choice song from Level 3.", duration:120 },
  ...
  { num:15, title:"The Dm Chord", level:4,
    ...
    review:{ chords:["C","Am","F"], text:"Pop loop with root-fifth bass.", duration:120 },
    ...
    songSlice:{ text:"Am \u2192 Dm cycle with root-fifth bass.",
                song:"Autumn Leaves", duration:240, observePriming:15 },
  ...
  { num:16, title:"The G7 Chord \u2014 The Magnet", level:4,
    ...
    review:{ chords:["Am","Dm"], text:"Am \u2192 Dm transitions.", duration:120 },
  ...
  { num:17, title:"Jazz Day", level:4,
    ...
    review:{ chords:["Dm","G7","C"], text:"ii-V-I pattern.", duration:120 },
  ...
  { num:18, title:"Hallelujah", level:4,
    ...
    review:{ chords:["Am","Dm","G7","C"], text:"Jazz turnaround.", duration:120 },
    newMove:{ text:"'Hallelujah' uses C, Am, F, G \u2014 chords you already know!",
              chord:"C", steps:["watch","shadow","try","refine"],
              watchDuration:30, shadowDuration:30, tryDuration:120, refineDuration:60 },
    songSlice:{ text:"Play along at 0.8x speed.",
                song:"Hallelujah", duration:240, observePriming:15 },
  ...
  { num:19, title:"Piano Man", level:4,
    ...
    review:{ chords:["C","Am","F","G"], text:"'Hallelujah' progression.", duration:120 },
    ...
    songSlice:{ text:"Simplified 'Piano Man' with waltz bass.",
                song:"Piano Man", duration:240, observePriming:15 },
    victoryLap:{ text:"Record.", duration:60 },
  ...
  { num:20, title:"Level 4 Boss \u2014 Root-Fifth-Octave", level:4,
    ...
    review:{ chords:["C","Dm","G7","F","Am"], text:"Learner's choice song.", duration:120 },
  ...
  { num:21, title:"Welcome to G \u2014 Meet F#", level:5,
    ...
    review:{ chords:["C","G","Am"], text:"Pop loop, root-fifth-octave bass.", duration:120 },
    ...
    songSlice:{ text:"G \u2192 D \u2192 Em \u2192 C. Key of G basics.",
                song:"Wonderwall", duration:240, observePriming:15 },
  ...
  { num:22, title:"Bm \u2014 The Dark Horse", level:5,
    ...
    review:{ chords:["G","D"], text:"G \u2192 D transitions.", duration:120 },
    ...
    songSlice:{ text:"Em \u2192 Bm \u2192 D \u2192 G progression.",
                song:"Country Roads", duration:240, observePriming:15 },
  ...
  { num:23, title:"Em7 \u2014 Your First 7th Chord", level:5,
    ...
    review:{ chords:["G","D","Bm"], text:"Key of G chords.", duration:120 },
    ...
    songSlice:{ text:"G \u2192 Em7 \u2192 C \u2192 D. A dreamy pop sound.",
                song:"Perfect", duration:240, observePriming:15 },
  ...
  { num:24, title:"Wonderwall Deep Dive", level:5,
    ...
    review:{ chords:["Em7","G","D"], text:"Key of G with Em7.", duration:120 },
  ...
  { num:25, title:"Country Roads", level:5,
    ...
    review:{ chords:["G","D","Em","C"], text:"Key of G progressions.", duration:120 },
  ...
  { num:26, title:"Perfect by Ed Sheeran", level:5,
    ...
    review:{ chords:["G","Em","C","D"], text:"Country Roads progression.", duration:120 },
  ...
  { num:27, title:"Key of G Review", level:5,
    ...
    review:{ chords:["G","D","Bm","Em7","C"], text:"All key of G chords.", duration:120 },
  ...
  { num:28, title:"Level 5 Boss \u2014 Alberti Bass Preview", level:5,
    ...
    review:{ chords:["G","D","Em","C","Bm"], text:"Full key of G.", duration:120 },
  ...
  { num:29, title:"Meet Bb \u2014 The Flat Side", level:6,
    ...
    review:{ chords:["F","C","G"], text:"I-IV-V in C with Alberti bass.", duration:120 },
    ...
    songSlice:{ text:"F \u2192 Bb \u2192 C \u2192 F. Key of F basics.",
                song:"Lean on Me", duration:240, observePriming:15 },
  ...
  { num:30, title:"Gm \u2014 Minor in F", level:6,
    ...
    review:{ chords:["F","Bb","C"], text:"Key of F basics.", duration:120 },
    ...
    songSlice:{ text:"Bb \u2192 Gm \u2192 F \u2192 C progression.",
                song:"Can't Help Falling in Love", duration:240, observePriming:15 },
  ...
  { num:31, title:"Dm7 \u2014 Adding Color", level:6,
    ...
    review:{ chords:["F","Bb","Gm"], text:"Key of F chords.", duration:120 },
  ...
  { num:32, title:"Lean on Me Deep Dive", level:6,
    ...
    review:{ chords:["F","Bb","Gm","Dm7"], text:"Key of F review.", duration:120 },
  ...
  { num:33, title:"Can't Help Falling in Love", level:6,
    ...
    review:{ chords:["C","F","Bb","Gm"], text:"Key of F songs.", duration:120 },
  ...
  { num:34, title:"Level 6 Boss \u2014 Syncopated Bass", level:6,
    ...
    review:{ chords:["F","Bb","Dm7","C"], text:"Key of F mastery.", duration:120 },
  ...
  { num:35, title:"Cmaj7 \u2014 The Dreamy Sound", level:7,
    ...
    review:{ chords:["C","F","Am","G"], text:"Pop loop with syncopated bass.", duration:120 },
    ...
    songSlice:{ text:"C \u2192 Cmaj7 \u2192 F \u2192 Fmaj7. Color chord sequence.",
                song:"Imagine", duration:240, observePriming:15 },
  ...
  { num:36, title:"Fmaj7 \u2014 Dreamy Part 2", level:7,
    ...
    review:{ chords:["C","Cmaj7"], text:"C to Cmaj7 transitions.", duration:120 },
  ...
  { num:37, title:"Am7 \u2014 Jazz Minor", level:7,
    ...
    review:{ chords:["Cmaj7","Fmaj7"], text:"Maj7 transitions.", duration:120 },
    ...
    songSlice:{ text:"Am7 \u2192 Dm7 \u2192 G7 \u2192 Cmaj7. The jazz ii-V-I-IV.",
                song:"Fly Me to the Moon", duration:240, observePriming:15 },
  ...
  { num:38, title:"Imagine Deep Dive", level:7,
    ...
    review:{ chords:["Am7","Dm7","G7","Cmaj7"], text:"Jazz progression.", duration:120 },
  ...
  { num:39, title:"Fly Me to the Moon", level:7,
    ...
    review:{ chords:["Cmaj7","Fmaj7","Am7"], text:"Color chord review.", duration:120 },
  ...
  { num:40, title:"All of Me (John Legend)", level:7,
    ...
    review:{ chords:["Am7","Dm7","G7","Cmaj7","Fmaj7"], text:"Jazz chords.", duration:120 },
    newMove:{ text:"'All of Me': Am \u2192 F \u2192 C \u2192 G. Familiar chords, new feel at 63 BPM.",
              chord:"Am", steps:["watch","shadow","try","refine"],
              watchDuration:30, shadowDuration:30, tryDuration:120, refineDuration:60 },
    songSlice:{ text:"'All of Me' play-along.",
                song:"All of Me", duration:240, observePriming:15 },
    victoryLap:{ text:"Record.", duration:60 },
  ...
  { num:41, title:"Color Chord Mixdown", level:7,
    ...
    review:{ chords:["Cmaj7","Am7","Dm7","G7","Fmaj7"], text:"All 7th chords.", duration:120 },
  ...
  { num:42, title:"Level 7 Boss \u2014 Walking Bass Preview", level:7,
    ...
    review:{ chords:["Cmaj7","Am7","Fmaj7","G7"], text:"Level 7 mastery.", duration:120 },
  ...
  { num:43, title:"Eb Major \u2014 New Territory", level:8,
    ...
    review:{ chords:["Cmaj7","Am7","G7"], text:"Jazz progression with walking bass.", duration:120 },
    ...
    songSlice:{ text:"Eb \u2192 Bb \u2192 Fm. 'Clocks' progression!",
                song:"Clocks", duration:240, observePriming:15 },
  ...
  { num:44, title:"Fm \u2014 Minor in Eb", level:8,
    ...
    review:{ chords:["Eb","Bb"], text:"Eb \u2192 Bb transitions.", duration:120 },
  ...
  { num:45, title:"C7 \u2014 The Blues Chord", level:8,
    ...
    review:{ chords:["Eb","Fm","Bb"], text:"Key of Eb.", duration:120 },
  ...
  { num:46, title:"Bohemian Rhapsody", level:8,
    ...
    review:{ chords:["C7","Eb","Fm","Bb"], text:"Level 8 chords.", duration:120 },
    newMove:{ text:"Simplified Bohemian Rhapsody: Bb \u2192 C \u2192 F \u2192 Gm \u2192 Eb \u2192 Bb.",
              chord:"Bb", steps:["watch","shadow","try","refine"],
              watchDuration:30, shadowDuration:30, tryDuration:120, refineDuration:60 },
    songSlice:{ text:"'Bohemian Rhapsody' simplified play-along.",
                song:"Bohemian Rhapsody", duration:240, observePriming:15 },
    victoryLap:{ text:"Record.", duration:60 },
  ...
  { num:48, title:"Prelude in C (Bach)", level:8,
    ...
    review:{ chords:["Am","Dm","G7","C"], text:"Classical progressions.", duration:120 },
    newMove:{ text:"Prelude: C \u2192 Dm7 \u2192 G7 \u2192 C \u2192 Am \u2192 Fmaj7. All arpeggiated.",
              chord:"C", steps:["watch","shadow","try","refine"],
              watchDuration:30, shadowDuration:30, tryDuration:120, refineDuration:60 },
    songSlice:{ text:"'Prelude in C' play-along.",
                song:"Prelude in C", duration:240, observePriming:15 },
    victoryLap:{ text:"Record.", duration:60 },
  ...
  { num:49, title:"Your Recital", level:8,
    ...
    review:{ chords:["C","Am","G","F","Dm","Em"], text:"All core chords.", duration:120 },
    ...
    victoryLap:{ text:"Record your recital!", duration:120 },
  ...
  { num:50, title:"Graduation Day", level:8,
    ...
    newMove:{ text:"Free play. Improvise. Create. You have all the tools.",
              chord:"C", steps:["watch","shadow","try","refine"],
              watchDuration:30, shadowDuration:60, tryDuration:180, refineDuration:60 },
    songSlice:{ text:"Play any song you want. You earned it.",
                song:"Let It Be", duration:300, observePriming:15 },
    victoryLap:{ text:"Graduation! Record your best performance. You are a pianist.", duration:120 },
...
// ── BADGES (expanded 15+) ──
var BADGES = [
  { id:"first_chord",  label:"First Note",     icon:"\u{1F3B9}", desc:"Complete Session 1" },
  { id:"streak_3",     label:"On Fire!",        icon:"\u{1F525}", desc:"3-day streak" },
  { id:"streak_7",     label:"Unstoppable",     icon:"\u{1F31F}", desc:"7-day streak" },
  { id:"streak_30",    label:"Iron Will",       icon:"\u{1F48E}", desc:"30-day streak" },
  { id:"level_2",      label:"Neighbor Chords", icon:"\u{1F3E0}", desc:"Reach Level 2" },
  { id:"level_3",      label:"Emotional",       icon:"\u{1F3AD}", desc:"Reach Level 3" },
  { id:"level_4",      label:"Full Palette",    icon:"\u{1F3A8}", desc:"Reach Level 4" },
  { id:"level_5",      label:"Black Keys",      icon:"\u{2B50}",  desc:"Reach Level 5" },
  { id:"level_6",      label:"Flat Side",       icon:"\u{1F30A}", desc:"Reach Level 6" },
  { id:"level_7",      label:"Color Master",    icon:"\u{1F308}", desc:"Reach Level 7" },
  { id:"level_8",      label:"Graduate",        icon:"\u{1F393}", desc:"Reach Level 8" },
  { id:"sessions_10",  label:"Dedicated",       icon:"\u{1F4AA}", desc:"Complete 10 sessions" },
  { id:"sessions_25",  label:"Halfway",         icon:"\u{1F3C3}", desc:"Complete 25 sessions" },
  { id:"sessions_50",  label:"Maestro",         icon:"\u{1F3C6}", desc:"Complete all 50 sessions" },
  { id:"drills_5",     label:"Quick Fingers",   icon:"\u{26A1}",  desc:"Complete 5 drills" },
  { id:"songs_3",      label:"Performer",       icon:"\u{1F3B6}", desc:"Practice 3 songs" },
  { id:"songs_10",     label:"Repertoire",      icon:"\u{1F4DA}", desc:"Practice 10 songs" },
  { id:"comeback",     label:"Comeback Kid",    icon:"\u{1F49A}", desc:"Return after 3+ days" },
  { id:"jackpot",      label:"Lucky Break",     icon:"\u{1F340}", desc:"Hit a jackpot reward" },
