/* ───────── PianoSpark – cloud/storage.js ───────── */
/* Canonical sync payload: build and apply cloud snapshots */
(function(){
  ...
  function applyCloudSnapshot(snapshot){
    ...
    if(snapshot.editor){
      S.editorLibrary = snapshot.editor.editorLibrary || [];
