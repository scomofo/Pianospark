/* PianoSpark – home/home_engine.js */
/* Gathers data from all systems into one dashboard summary */
(function(){
  ...
  function buildHomeProfileSummary(){
    return {
      ...
      xp: S.playerXP || 0,
      streak: S.practiceStreak || S.streak || 0
    };
  }

  function buildHomePracticeSummary(){
    return {
      todayPlan: S.dailyPracticePlan || S.practicePlan || [],
