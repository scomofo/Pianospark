/* ───────── PianoSpark – import/midi_seed.js ───────── */
/* Converts normalized MIDI + track assignments into Spark seed charts */
(function(){
  ...
  function groupNotesIntoChords(notes, thresholdSec){
    ...
    for(var i=0;i<notes.length;i++){
      var n = notes[i];
      if(!cur){
        cur = { startSec:n.startSec, durSec:n.durSec, notes:[n.note], velocity:n.velocity };
