/* editor/validators.js — Shape/timing validation (handoffs 6, 7, 8) */
(function(){
  ...
  function validateEditorObject(obj){
    ...
    if(isChartObject(obj)){
      ...
      validateLanePlacement(obj, errors);
  ...
  /* Handoff 7 — event ordering check */
  ...
  /* Handoff 9 — lane placement check */
